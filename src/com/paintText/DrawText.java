...
public class DrawText {  
    ...
    public static void main(String[] args) {  
    	...
    	DrawText tt = new DrawText();  
  
        BufferedImage d = tt.loadImageLocal("D:\\cc.jpg");  
        BufferedImage b = tt.loadImageLocal("D:\\logo.png");  
        //往图片上写文件    
         tt.writeImageLocal("D:\\11.jpg",tt.modifyImage(d,"曹原",90,90));  
         //将多张图片合在一起  
        tt.writeImageLocal("D:\\cc.png", tt.modifyImagetogeter(b, d));  
